...
int rm_load(struct insn *i, uint64_t n, int w, int *m) {
    (void)i;
    (void)n;
    seen.loads++;
    seen.width = w;
...
void emit_ea(struct insn *i, uint64_t n) {
    (void)i;
    (void)n;
    seen.ea++;
}

void e_movconst(int d, uint64_t v) {
    seen.destination = d;
    seen.constant = v;
    seen.descriptor = v;
}
...
void e_lsl_i(int d, int s, int c, int sf) {
    (void)sf;
    seen.shifts++;
    seen.kind = 4;
    seen.destination = d;
...
void e_lsr_i(int d, int s, int c, int sf) {
    e_lsl_i(d, s, c, sf);
    seen.kind = 5;
}

void e_asr_i(int d, int s, int c, int sf) {
    e_lsl_i(d, s, c, sf);
    seen.kind = 7;
}

void e_ror_i(int d, int s, int c, int sf) {
    e_lsl_i(d, s, c, sf);
    seen.kind = 1;
}

void e_rot_flags_cl(int r, int k, int w) {
    (void)r;
    seen.flags++;
    seen.kind = k;
    seen.width = w;
...
void e_rot_flags_const(int r, int k, int w, int c) {
    e_rot_flags_cl(r, k, w);
    seen.count = c;
}
...
void e_nzcv_save_setcf(int c) {
    (void)c;
    seen.flags++;
}

void e_nzcv_set_of(int o) {
    (void)o;
    seen.flags++;
}

void e_pf_save(int s) {
    (void)s;
    seen.parity++;
}
...
void e_uxt(int d, int s, int w) {
    (void)d;
    (void)s;
    (void)w;
}

void e_sxt(int d, int s, int w) {
    (void)d;
    (void)s;
    (void)w;
}
...
void e_rrr(uint32_t i, int d, int l, int r, int sf, int sh) {
    (void)i;
    (void)d;
    (void)l;
    (void)r;
...
void e_shv(uint32_t i, int d, int s, int c, int sf) {
    (void)i;
    (void)sf;
    seen.shifts++;
    seen.destination = d;
...
void e_tst(int s, int sf) {
    (void)s;
    (void)sf;
    seen.flags++;
}

void e_csel(int d, int t, int f, int c, int sf) {
    (void)d;
    (void)t;
    (void)f;
    (void)c;
...
void e_subi_s(int d, int s, unsigned v, int sf) {
    e_subi(d, s, v, sf);
}
