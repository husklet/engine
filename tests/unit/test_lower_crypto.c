...
void e_movz(int destination, uint32_t value, int shift) {
    (void)destination;
    (void)value;
    (void)shift;
}
...
void e_subi_s(int rd, int rn, unsigned imm12, int sf) {
    (void)rd;
    (void)rn;
    (void)imm12;
    (void)sf;
...
void e_cset(int rd, int cond, int sf) {
    (void)rd;
    (void)cond;
    (void)sf;
}
