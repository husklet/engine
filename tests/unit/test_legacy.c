...
static void initialize(struct cpu *cpu, uint64_t number) {
    ...
    for (size_t index = 0; index < 16; ++index) cpu->r[index] = UINT64_C(0x1000) + index;
    cpu->r[RAX] = number;
}
...
int main(void) {
    ...
    const rewrite rewrites[] = {
        {2, 257, cwd, 0x1007, 0x1006, 0x1002, 0x1008},
        {4, 262, cwd, 0x1007, 0x1006, 0, 0x1008},
        {6, 262, cwd, 0x1007, 0x1006, 0x100, 0x1008},
        {21, 269, cwd, 0x1007, 0x1006, 0x100a, 0x1008},
        {83, 258, cwd, 0x1007, 0x1006, 0x100a, 0x1008},
        {84, 263, cwd, 0x1007, 0x200, 0x100a, 0x1008},
        {87, 263, cwd, 0x1007, 0, 0x100a, 0x1008},
        {85, 257, cwd, 0x1007, 0x241, 0x1006, 0x1008},
        {89, 267, cwd, 0x1007, 0x1006, 0x1002, 0x1008},
        {90, 268, cwd, 0x1007, 0x1006, 0x100a, 0x1008},
        {88, 266, 0x1007, cwd, 0x1006, 0x100a, 0x1008},
        {92, 260, cwd, 0x1007, 0x1006, 0x1002, 0},
        {94, 260, cwd, 0x1007, 0x1006, 0x1002, 0x100},
        {133, 259, cwd, 0x1007, 0x1006, 0x1002, 0x1008},
        {82, 264, cwd, 0x1007, cwd, 0x1006, 0x1008},
        {86, 265, cwd, 0x1007, cwd, 0x1006, 0},
    };
