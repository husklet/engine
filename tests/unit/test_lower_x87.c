...
void e_cset(int d, int c, int sf) {
    (void)d;
    (void)c;
    (void)sf;
}
...
void e_lsl_i(int d, int s, int i, int sf) {
    (void)d;
    (void)s;
    (void)i;
    (void)sf;
...
void e_lsr_i(int d, int s, int i, int sf) {
    (void)d;
    (void)s;
    (void)i;
    (void)sf;
...
void e_subi_s(int d, int s, unsigned i, int sf) {
    (void)d;
    (void)s;
    (void)i;
    (void)sf;
