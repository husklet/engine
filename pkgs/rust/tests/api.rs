...
fn accepts_api_capabilities(_: hl_engine_api::spec::EngineCapabilities) {}
fn accepts_api_filesystem(_: hl_engine_api::spec::FilesystemSpec) {}
fn accepts_api_resources(_: hl_engine_api::spec::ResourceSpec) {}
fn accepts_api_validation(_: hl_engine_api::spec::Validation) {}
fn accepts_api_attach(_: hl_engine_api::control::AttachRequest) {}
