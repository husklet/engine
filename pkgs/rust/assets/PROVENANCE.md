...
The committed archives and generated provenance below are still the remote
`0.1.28` release assets. They have not yet been rebuilt from the `0.1.29`
sources. Keep these recorded hashes unchanged until
`make refresh-crate-archives` produces and verifies both replacement archives;
then update the binaries and generated block together.
