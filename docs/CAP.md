...
| Provider framework | manifest, negotiation, prepare, namespace, handles, memory, events, lifecycle | two hardwired built-in provider IDs | runtime provider registry and transactional preparation/lifecycle |
